---
kind: story
title: "Phase 0 — Ticket Breakdown"
status: 0
---

# Phase 0 — Ticket Breakdown

**Sixteen tickets** covering the Phase 0 scope in `treasury-alm-risk-platform` §6. Parent:
...
flowchart TB
  ...
  P06 --> P14
  P09 --> P12
  P12 --> P16[P0-16 Operational<br/>readiness]
  P13 --> P16
  P14 --> P16
  P07 --> P12
  P02 --> P09
...
| **6** | **P0-16** | **The phase is operationally live** — parallel run explained, on-call exercised, forums standing |
...
**~~Deployment and monitoring tickets are deliberately absent.~~ Superseded.** That statement stood
here, was inherited unexamined by six later breakdowns, and a critique found **97 build tickets with no
cutover, parallel run, rollback, training or operational acceptance anywhere in the programme.**
**P0-16 now carries Phase 0's operational readiness**, and every later phase has an equivalent.
...
| P0-10 | Minimal encumbrance register | `d6-collateral-and-securities-financing` §2, §4; D10 §3.5; parent §6.2 |
...
| P0-16 | Operational readiness | *added post-critique* — see the ticket |
